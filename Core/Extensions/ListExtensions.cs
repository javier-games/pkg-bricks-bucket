...
namespace BricksBucket.Core
{
    ...
    public static class ListExtensions
    {
        ...
        {
            if (!list.HasIndex (a))
                throw Utils.IndexOutOfRangeException (list, a);

            if (!list.HasIndex (b))
                throw Utils.IndexOutOfRangeException (list, b);
        ...
        {
            if (size < 0) throw Utils.IndexOutOfRangeException (list, size);
        ...
        {
            if (list.IsNullOrEmpty ()) throw Utils.NullOrEmptyException (list);
